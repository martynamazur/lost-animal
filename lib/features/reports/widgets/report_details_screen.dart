...
import 'package:lostanimal/shared/widgets/bottom_contact_bar.dart';
import 'package:lostanimal/shared/widgets/details_filled_card.dart';
import 'package:lostanimal/shared/widgets/details_outlined_card.dart';
import 'package:lostanimal/features/gallery/widgets/image_gallery.dart';
import 'package:lostanimal/features/reports/provider/report_details_notifier.dart';
import 'package:lostanimal/features/reports/provider/report_provider.dart';
import 'package:lostanimal/shared/utils/count_passed_time.dart';
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                Flexible(
                                  child: SizedBox(
                                    ...
                                    child: DetailsOutlinedCard(
                                      ...
                                      text:
                                          'Missing since ${formatElapsedTime(report.missingSince)} ago',
                                    ),
                                  ),
                                ),
                              ],
                          ...
                          DetailsOutlinedCard(
                            ...
                            text:
                                'Reported: ${formatDate(report.missingSince)}',
                          ),

                          if (report.coloration != null ||
                              report.coloration!.isNotEmpty)
                            DetailsFilledCard(
                              icon: Icons.color_lens,
                              text:
                                  'Fur colors & special marks: ${report.coloration}',
                            ),
