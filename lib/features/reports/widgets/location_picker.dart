...
class _LocationPickerState extends ConsumerState<LocationPicker> {
                ...
                child: FutureBuilder(
                  ...
                  builder:
                      (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
                        ...
                        final center =
                            snapshot.data ?? const LatLng(52.2297, 21.0122);
                        return GoogleMap(
                          gestureRecognizers:
                          ...
                          onTap: (position) async {
                            ...
                            if (cityName == null) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text(
                                    'Nie udało się rozpoznać miejscowości',
                                  ),
                                ),
                              );
                            }
                            ref
                                ...
                                .updateLocation(lat, lng, _cityController.text);
                          },
                          markers: _markers,
                        );
                      },
  ...
  Future<LatLng?> _getCurrentLocation() async {
    ...
    setState(() {
      _initialCenter = loc;
      _markers.add(
        Marker(markerId: const MarkerId('user-location'), position: loc),
      );
    });
