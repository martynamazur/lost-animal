...
class DetailsFilledCard extends StatelessWidget {
  ...
  final IconData icon;
  final String? type;
  const DetailsFilledCard({super.key, required this.icon, required this.text, this.subText, this.type});
        ...
        child:
            Row(
              ...
              children: [
                ...
                Expanded(
                    child: Text(text, style: TextStyle(color: type != null ? Colors.white : Colors.black))
                ),
              ],
            ),
